 ...
 */
    ...
    function detectLan($inputStr='',$grantType, $scopeUrl, $clientID, $clientSecret, $authUrl){
        //Dectect Lan
        ...
        //Input String.
        //    $inputStr     = "오늘 새벽1시에 출발하여 20분만에 도착하니....우와....사람들이 정말 많습니다.지금까지 마카티 꽈달루페 시장만 10여년을 다녔는데....후회...";
        //HTTP Detect Method URL.
            $detectMethodUrl = "http://api.microsofttranslator.com/V2/Http.svc/Detect?text=".urlencode($inputStr);
        //Call the curlRequest.
            $strResponse = $authObj->curlRequest($detectMethodUrl, $authHeader);
    ...
    function transLan($inputTXT='',$languageCode){
    /////translate
    //Set the params.//
